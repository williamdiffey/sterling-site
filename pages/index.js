  ...
  return (
    <Layout>
      <div className='container'>
        ...
        <main>
          <h1 className='title'>Welcome to Sterling something something</h1>
          <p>
            You can check every meta tag know to man is now in the head - copy
            to each page
          </p>
